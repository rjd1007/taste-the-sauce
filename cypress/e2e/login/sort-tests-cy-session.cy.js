...
// Tip: you can click on the "session" in the Command Log to see the saved information
...
beforeEach(() => {
  ...
  // after using session you must do something i.e. visit the page "/inventory.html"
